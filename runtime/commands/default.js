...
Commands.hello = {
  ...
  level: 0,
  fn: function (msg, suffix, bot) {
    msg.channel.sendMessage('Hi ' + msg.author.username + ", I'm " + bot.User.username + ' and I was developed by the team over at TheSharks and improved by DaKapo! Improve me by contributing to my source code on GitHub: https://github.com/Jonasdero/eagle-bot')
  }
}
